...
if __name__ == "__main__":
    ...
    manager.update_context("current_phase", "Implementing Authentication and User Roles")
    manager.update_context("backend_stack", "Node.js, Express, Sequelize, MySQL, Bcrypt.js, JWT")
    manager.update_context("frontend_stack", "Web Components, Client-side routing for dashboards")
